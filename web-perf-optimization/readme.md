...
This is a technical lecture about discussing best practices for web site speed optimizations such as:
  ...
  - Javascript tricks.
    - Discuss the blocking behaviour of JS.
    - Async javascript.
    - Defer javascript.
...
### Using most common used libraries with a CDN
   ...
   - Checkout [CDNJS](http://cdnjs.com/index.html) for a great collection of CDN hosted js libraries. You can also make a request to add what you need.
